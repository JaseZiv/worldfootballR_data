...
# read in files
joined_finished <- read.csv(here("raw-data", "fbref-tm-player-mapping", "extra-leagues", "initial-match", "mls", "joined_finished.csv"), stringsAsFactors = F)
joined_missing <- read.csv(here("raw-data", "fbref-tm-player-mapping", "extra-leagues", "initial-match", "mls", "joined_missing_manual_fix.csv"), stringsAsFactors = F)
duplicate_players <- tryCatch(read.csv(here("raw-data", "fbref-tm-player-mapping", "extra-leagues", "initial-match", "mls", "duplicate_players_df_manual_fix.csv"), stringsAsFactors = F), 
