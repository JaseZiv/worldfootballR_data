...
fbref <- readRDS(here("raw-data", "fbref-tm-player-mapping", "extra-leagues", "initial-match", "fbref_mls.rds"))
tm <- readRDS(here("raw-data", "fbref-tm-player-mapping", "extra-leagues", "initial-match", "tm_players_mls.rds"))
...
write.csv(joined_finished, here("raw-data", "fbref-tm-player-mapping", "extra-leagues", "initial-match", "mls", "joined_finished.csv"), row.names = F)
write.csv(joined_missing, here("raw-data", "fbref-tm-player-mapping", "extra-leagues", "initial-match", "mls", "joined_missing.csv"), row.names = F)
write.csv(tm_unique, here("raw-data", "fbref-tm-player-mapping", "extra-leagues", "initial-match", "mls", "tm_unique.csv"), row.names = F)
write.csv(duplicate_players, here("raw-data", "fbref-tm-player-mapping", "extra-leagues", "initial-match", "mls", "duplicate_players_df.csv"), row.names = F)
